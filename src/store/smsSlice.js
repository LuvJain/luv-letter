...
const smsSlice = createSlice({
  ...
  reducers: {
     ...
     * Auto-generates id, createdAt, updatedAt, and sets initial status/retryCount.
    ...
    addMessage: {
      ...
      prepare({ recipientPhone, messageContent, scheduledTime }) {
     ...
     * Increments retryCount when status changes to FAILED.
     * @param {import('./sms.types.js').SmsState} state
