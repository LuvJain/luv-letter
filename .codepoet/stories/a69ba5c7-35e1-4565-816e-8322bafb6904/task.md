...
## When You're Done
When you have completed all acceptance criteria, create the file `.codepoet/stories/a69ba5c7-35e1-4565-816e-8322bafb6904/done.json` with this exact structure:
```json
{
  "status": "completed",
